    ...
    return (
       <div className="container subsection-recipes">
         <form className='form-horizontal' onSubmit={handleSubmit(this.submit)}>
           ...
           <label>Recipe Text Details</label>
           <Field
             name='title'
             label='Title'
           ...
           <label>Recipe Pictures URLs</label>
           <Field
             name='pictureIngredients'
             label="Ingredients picture"
             component={CustomInput}
           ...
           <label>Recipe Detailed Information</label>
           <Field
             name='length'
             label='Length'
             component={CustomInput}
